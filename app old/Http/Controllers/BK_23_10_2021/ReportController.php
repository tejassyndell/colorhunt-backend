...
// 		$data = DB::select("SELECT a.Id, a.ArticleNumber, c.Title as Category, sc.Name as Subcategory,  rs.SeriesName, rs.Series, (case when purchasereturn.ReturnNoPacks IS NULL then 0 else CASE WHEN CommaZeroValue(purchasereturn.ReturnNoPacks)= 0 THEN sum(purchasereturn.ReturnNoPacks) else CountNoPacks(purchasereturn.ReturnNoPacks) END end) as PurchaseReturnNoPacks, (case when salesreturn.NoPacks IS NULL then 0 else CASE WHEN CommaZeroValue(salesreturn.NoPacks)= 0 THEN sum(salesreturn.NoPacks) else CountNoPacks(salesreturn.NoPacks) END end) as SalesReturnNoPacks, (case when inwardcancellationlogs.NoPacks IS NULL then 0 else inwardcancellationlogs.NoPacks end) as TotalInwardCancellation, (case when stocktransfer.TotalTransferNoPacks IS NULL then 0 else stocktransfer.TotalTransferNoPacks end) as TotalTransferNoPacks,(case when outletsalesreturn.NoPacks IS NULL then 0 else CASE WHEN CommaZeroValue(outletsalesreturn.NoPacks)= 0 THEN sum(outletsalesreturn.NoPacks) else CountNoPacks(outletsalesreturn.NoPacks) END end) as OutletSalesReturnNoPacks, (case when inward.NoPacks IS NULL then 0 else CASE WHEN CommaZeroValue(inward.NoPacks)= 0 THEN sum(inward.NoPacks) else sum(CountNoPacks(inward.NoPacks)) END end) as TotalInwardQuantity, (case when domesticqty.TotalDomesticOutQuantity IS NULL then 0 else domesticqty.TotalDomesticOutQuantity end) as TotalDomesticOutQuantity, (case when exportqty.TotalExportOutQuantity IS NULL then 0 else exportqty.TotalExportOutQuantity end) as TotalExportOutQuantity, inward.InwardDate FROM `article` a left join category c on c.Id=a.CategoryId left join subcategory sc on sc.Id=a.SubCategoryId left join rangeseries rs on rs.Id=a.SeriesId left join (select * from inward where InwardDate >= '".$startdate."' AND InwardDate <= '".$enddate."') inward on inward.ArticleId=a.Id left join (select ReturnNoPacks, ArticleId from purchasereturn where DATE(CreatedDate) >= '".$startdate."' AND DATE(CreatedDate) <= '".$enddate."') purchasereturn on purchasereturn.ArticleId=a.Id left join (select NoPacks, ArticleId from salesreturn where DATE(CreatedDate) >= '".$startdate."' AND DATE(CreatedDate) <= '".$enddate."') salesreturn on salesreturn.ArticleId=a.Id left join (select (case when stocktransfer.TransferNoPacks IS NULL then 0 else CASE WHEN CommaZeroValue(stocktransfer.TransferNoPacks)= 0 THEN sum(stocktransfer.TransferNoPacks) else CountNoPacks(stocktransfer.TransferNoPacks) END end) as TotalTransferNoPacks, TransferArticleId from stocktransfer where DATE(created_at) >= '".$startdate."' AND DATE(created_at) <= '".$enddate."' group by TransferArticleId) stocktransfer on stocktransfer.TransferArticleId=a.Id left join (select (case when inwardcancellationlogs.NoPacks IS NULL then 0 else CASE WHEN CommaZeroValue(inwardcancellationlogs.NoPacks)= 0 THEN sum(inwardcancellationlogs.NoPacks) else CountNoPacks(inwardcancellationlogs.NoPacks) END end) as NoPacks, ArticleId from inwardcancellationlogs where DATE(created_at) >= '".$startdate."' AND DATE(created_at) <= '".$enddate."' group by ArticleId) inwardcancellationlogs on inwardcancellationlogs.ArticleId=a.Id left join (select NoPacks, ArticleId from outletsalesreturn where DATE(CreatedDate) >= '".$startdate."' AND DATE(CreatedDate) <= '".$enddate."') outletsalesreturn on outletsalesreturn.ArticleId=a.Id left join (select outward.ArticleId, (case when outward.NoPacks IS NULL then 0 else CASE WHEN CommaZeroValue(outward.NoPacks)= 0 THEN sum(outward.NoPacks) else sum(CountNoPacks(outward.NoPacks)) END end) as TotalDomesticOutQuantity, outwardnumber.Id, outwardnumber.OutwardDate from outwardnumber inner join outward on outward.OutwardNumberId=outwardnumber.Id inner join party p on p.Id=outward.PartyId where p.Id != 45 and outwardnumber.OutwardDate  >= '".$startdate."' AND outwardnumber.OutwardDate  <= '".$enddate."' group by outward.ArticleId) domesticqty  on domesticqty.ArticleId=a.Id left join (select outward.ArticleId, (case when outward.NoPacks IS NULL then 0 else CASE WHEN CommaZeroValue(outward.NoPacks)= 0 THEN sum(outward.NoPacks) else sum(CountNoPacks(outward.NoPacks)) END end) as TotalExportOutQuantity, outwardnumber.Id, outwardnumber.OutwardDate from outwardnumber inner join outward on outward.OutwardNumberId=outwardnumber.Id inner join party p on p.Id=outward.PartyId where p.Id = 45 and outwardnumber.OutwardDate  >= '".$startdate."' AND outwardnumber.OutwardDate  <= '".$enddate."' group by outward.ArticleId) exportqty  on exportqty.ArticleId=a.Id  group by a.Id");
// 		$data_open = DB::select("SELECT a.Id, a.ArticleNumber, c.Title as Category, sc.Name as Subcategory,  rs.SeriesName, rs.Series, (case when purchasereturn1.ReturnNoPacks IS NULL then 0 else CASE WHEN CommaZeroValue(purchasereturn1.ReturnNoPacks)= 0 THEN sum(purchasereturn1.ReturnNoPacks) else CountNoPacks(purchasereturn1.ReturnNoPacks) END end) as PurchaseReturnNoPacks_Open, (case when salesreturn1.NoPacks IS NULL then 0 else CASE WHEN CommaZeroValue(salesreturn1.NoPacks)= 0 THEN sum(salesreturn1.NoPacks) else CountNoPacks(salesreturn1.NoPacks) END end) as SalesReturnNoPacks_Open, (case when inwardcancellationlogs1.NoPacks IS NULL then 0 else inwardcancellationlogs1.NoPacks end) as TotalInwardCancellation_Open, (case when stocktransfer1.TotalTransferNoPacks IS NULL then 0 else stocktransfer1.TotalTransferNoPacks end) as TotalTransferNoPacks_Open,(case when outletsalesreturn1.NoPacks IS NULL then 0 else CASE WHEN CommaZeroValue(outletsalesreturn1.NoPacks)= 0 THEN sum(outletsalesreturn1.NoPacks) else CountNoPacks(outletsalesreturn1.NoPacks) END end) as OutletSalesReturnNoPacks_Open, (case when inward1.NoPacks IS NULL then 0 else CASE WHEN CommaZeroValue(inward1.NoPacks)= 0 THEN sum(inward1.NoPacks) else sum(CountNoPacks(inward1.NoPacks)) END end) as TotalInwardQuantity_Open, (case when domesticqty1.TotalDomesticOutQuantity IS NULL then 0 else domesticqty1.TotalDomesticOutQuantity end) as TotalDomesticOutQuantity_Open, (case when exportqty1.TotalExportOutQuantity IS NULL then 0 else exportqty1.TotalExportOutQuantity end) as TotalExportOutQuantity_Open, inward1.InwardDate FROM `article` a left join category c on c.Id=a.CategoryId left join subcategory sc on sc.Id=a.SubCategoryId left join rangeseries rs on rs.Id=a.SeriesId left join (select * from inward where InwardDate < '".$startdate."') inward1 on inward1.ArticleId=a.Id left join (select ReturnNoPacks, ArticleId from purchasereturn where DATE(CreatedDate) < '".$startdate."') purchasereturn1 on purchasereturn1.ArticleId=a.Id left join (select NoPacks, ArticleId from salesreturn where DATE(CreatedDate) < '".$startdate."') salesreturn1 on salesreturn1.ArticleId=a.Id left join (select (case when stocktransfer.TransferNoPacks IS NULL then 0 else CASE WHEN CommaZeroValue(stocktransfer.TransferNoPacks)= 0 THEN sum(stocktransfer.TransferNoPacks) else CountNoPacks(stocktransfer.TransferNoPacks) END end) as TotalTransferNoPacks, TransferArticleId from stocktransfer where DATE(created_at) < '".$startdate."' group by TransferArticleId) stocktransfer1 on stocktransfer1.TransferArticleId=a.Id left join (select (case when inwardcancellationlogs.NoPacks IS NULL then 0 else CASE WHEN CommaZeroValue(inwardcancellationlogs.NoPacks)= 0 THEN sum(inwardcancellationlogs.NoPacks) else CountNoPacks(inwardcancellationlogs.NoPacks) END end) as NoPacks, ArticleId from inwardcancellationlogs where DATE(created_at) < '".$startdate."' group by ArticleId) inwardcancellationlogs1 on inwardcancellationlogs1.ArticleId=a.Id left join (select NoPacks, ArticleId from outletsalesreturn where DATE(CreatedDate) < '".$startdate."') outletsalesreturn1 on outletsalesreturn1.ArticleId=a.Id left join (select outward.ArticleId, (case when outward.NoPacks IS NULL then 0 else CASE WHEN CommaZeroValue(outward.NoPacks)= 0 THEN sum(outward.NoPacks) else sum(CountNoPacks(outward.NoPacks)) END end) as TotalDomesticOutQuantity, outwardnumber.Id, outwardnumber.OutwardDate from outwardnumber inner join outward on outward.OutwardNumberId=outwardnumber.Id inner join party p on p.Id=outward.PartyId where p.Id != 45 and outwardnumber.OutwardDate < '".$startdate."' group by outward.ArticleId) domesticqty1  on domesticqty1.ArticleId=a.Id left join (select outward.ArticleId, (case when outward.NoPacks IS NULL then 0 else CASE WHEN CommaZeroValue(outward.NoPacks)= 0 THEN sum(outward.NoPacks) else sum(CountNoPacks(outward.NoPacks)) END end) as TotalExportOutQuantity, outwardnumber.Id, outwardnumber.OutwardDate from outwardnumber inner join outward on outward.OutwardNumberId=outwardnumber.Id inner join party p on p.Id=outward.PartyId where p.Id = 45 and outwardnumber.OutwardDate  < '".$startdate."' group by outward.ArticleId) exportqty1  on exportqty1.ArticleId=a.Id group by a.Id");
	
// 	    $data = DB::select("SELECT a.Id, a.ArticleNumber, c.Title as Category, sc.Name as Subcategory,  rs.SeriesName, rs.Series, (case when purchasereturn.ReturnNoPacks IS NULL then 0 else CASE WHEN CommaCheck(purchasereturn.ReturnNoPacks)= 0 THEN sum(purchasereturn.ReturnNoPacks) else CountNoPacks(purchasereturn.ReturnNoPacks) END end) as PurchaseReturnNoPacks, (case when salesreturn.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(salesreturn.NoPacks)= 0 THEN sum(salesreturn.NoPacks) else CountNoPacks(salesreturn.NoPacks) END end) as SalesReturnNoPacks, (case when inwardcancellationlogs.NoPacks IS NULL then 0 else inwardcancellationlogs.NoPacks end) as TotalInwardCancellation, (case when stocktransfer.TotalTransferNoPacks IS NULL then 0 else stocktransfer.TotalTransferNoPacks end) as TotalTransferNoPacks,(case when outletsalesreturn.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(outletsalesreturn.NoPacks)= 0 THEN sum(outletsalesreturn.NoPacks) else CountNoPacks(outletsalesreturn.NoPacks) END end) as OutletSalesReturnNoPacks, (case when inward.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(inward.NoPacks)= 0 THEN sum(inward.NoPacks) else sum(CountNoPacks(inward.NoPacks)) END end) as TotalInwardQuantity, (case when domesticqty.TotalDomesticOutQuantity IS NULL then 0 else domesticqty.TotalDomesticOutQuantity end) as TotalDomesticOutQuantity, (case when exportqty.TotalExportOutQuantity IS NULL then 0 else exportqty.TotalExportOutQuantity end) as TotalExportOutQuantity, inward.InwardDate FROM `article` a left join category c on c.Id=a.CategoryId left join subcategory sc on sc.Id=a.SubCategoryId left join rangeseries rs on rs.Id=a.SeriesId left join (select * from inward where InwardDate >= '".$startdate."' AND InwardDate <= '".$enddate."') inward on inward.ArticleId=a.Id left join (select ReturnNoPacks, ArticleId from purchasereturn where DATE(CreatedDate) >= '".$startdate."' AND DATE(CreatedDate) <= '".$enddate."') purchasereturn on purchasereturn.ArticleId=a.Id left join (select NoPacks, ArticleId from salesreturn where DATE(CreatedDate) >= '".$startdate."' AND DATE(CreatedDate) <= '".$enddate."') salesreturn on salesreturn.ArticleId=a.Id left join (select (case when stocktransfer.TransferNoPacks IS NULL then 0 else CASE WHEN CommaCheck(stocktransfer.TransferNoPacks)= 0 THEN sum(stocktransfer.TransferNoPacks) else CountNoPacks(stocktransfer.TransferNoPacks) END end) as TotalTransferNoPacks, TransferArticleId from stocktransfer where DATE(created_at) >= '".$startdate."' AND DATE(created_at) <= '".$enddate."' group by TransferArticleId) stocktransfer on stocktransfer.TransferArticleId=a.Id left join (select (case when inwardcancellationlogs.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(inwardcancellationlogs.NoPacks)= 0 THEN sum(inwardcancellationlogs.NoPacks) else CountNoPacks(inwardcancellationlogs.NoPacks) END end) as NoPacks, ArticleId from inwardcancellationlogs where DATE(created_at) >= '".$startdate."' AND DATE(created_at) <= '".$enddate."' group by ArticleId) inwardcancellationlogs on inwardcancellationlogs.ArticleId=a.Id left join (select NoPacks, ArticleId from outletsalesreturn where DATE(CreatedDate) >= '".$startdate."' AND DATE(CreatedDate) <= '".$enddate."') outletsalesreturn on outletsalesreturn.ArticleId=a.Id left join (select outward.ArticleId, (case when outward.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(outward.NoPacks)= 0 THEN sum(outward.NoPacks) else sum(CountNoPacks(outward.NoPacks)) END end) as TotalDomesticOutQuantity, outwardnumber.Id, outwardnumber.OutwardDate from outwardnumber inner join outward on outward.OutwardNumberId=outwardnumber.Id inner join party p on p.Id=outward.PartyId where p.Id != 45 and outwardnumber.OutwardDate  >= '".$startdate."' AND outwardnumber.OutwardDate  <= '".$enddate."' group by outward.ArticleId) domesticqty  on domesticqty.ArticleId=a.Id left join (select outward.ArticleId, (case when outward.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(outward.NoPacks)= 0 THEN sum(outward.NoPacks) else sum(CountNoPacks(outward.NoPacks)) END end) as TotalExportOutQuantity, outwardnumber.Id, outwardnumber.OutwardDate from outwardnumber inner join outward on outward.OutwardNumberId=outwardnumber.Id inner join party p on p.Id=outward.PartyId where p.Id = 45 and outwardnumber.OutwardDate  >= '".$startdate."' AND outwardnumber.OutwardDate  <= '".$enddate."' group by outward.ArticleId) exportqty  on exportqty.ArticleId=a.Id  group by a.Id");
// 		$data_open = DB::select("SELECT a.Id, a.ArticleNumber, c.Title as Category, sc.Name as Subcategory,  rs.SeriesName, rs.Series, (case when purchasereturn1.ReturnNoPacks IS NULL then 0 else CASE WHEN CommaCheck(purchasereturn1.ReturnNoPacks)= 0 THEN sum(purchasereturn1.ReturnNoPacks) else CountNoPacks(purchasereturn1.ReturnNoPacks) END end) as PurchaseReturnNoPacks_Open, (case when salesreturn1.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(salesreturn1.NoPacks)= 0 THEN sum(salesreturn1.NoPacks) else CountNoPacks(salesreturn1.NoPacks) END end) as SalesReturnNoPacks_Open, (case when inwardcancellationlogs1.NoPacks IS NULL then 0 else inwardcancellationlogs1.NoPacks end) as TotalInwardCancellation_Open, (case when stocktransfer1.TotalTransferNoPacks IS NULL then 0 else stocktransfer1.TotalTransferNoPacks end) as TotalTransferNoPacks_Open,(case when outletsalesreturn1.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(outletsalesreturn1.NoPacks)= 0 THEN sum(outletsalesreturn1.NoPacks) else CountNoPacks(outletsalesreturn1.NoPacks) END end) as OutletSalesReturnNoPacks_Open, (case when inward1.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(inward1.NoPacks)= 0 THEN sum(inward1.NoPacks) else sum(CountNoPacks(inward1.NoPacks)) END end) as TotalInwardQuantity_Open, (case when domesticqty1.TotalDomesticOutQuantity IS NULL then 0 else domesticqty1.TotalDomesticOutQuantity end) as TotalDomesticOutQuantity_Open, (case when exportqty1.TotalExportOutQuantity IS NULL then 0 else exportqty1.TotalExportOutQuantity end) as TotalExportOutQuantity_Open, inward1.InwardDate FROM `article` a left join category c on c.Id=a.CategoryId left join subcategory sc on sc.Id=a.SubCategoryId left join rangeseries rs on rs.Id=a.SeriesId left join (select * from inward where InwardDate < '".$startdate."') inward1 on inward1.ArticleId=a.Id left join (select ReturnNoPacks, ArticleId from purchasereturn where DATE(CreatedDate) < '".$startdate."') purchasereturn1 on purchasereturn1.ArticleId=a.Id left join (select NoPacks, ArticleId from salesreturn where DATE(CreatedDate) < '".$startdate."') salesreturn1 on salesreturn1.ArticleId=a.Id left join (select (case when stocktransfer.TransferNoPacks IS NULL then 0 else CASE WHEN CommaCheck(stocktransfer.TransferNoPacks)= 0 THEN sum(stocktransfer.TransferNoPacks) else CountNoPacks(stocktransfer.TransferNoPacks) END end) as TotalTransferNoPacks, TransferArticleId from stocktransfer where DATE(created_at) < '".$startdate."' group by TransferArticleId) stocktransfer1 on stocktransfer1.TransferArticleId=a.Id left join (select (case when inwardcancellationlogs.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(inwardcancellationlogs.NoPacks)= 0 THEN sum(inwardcancellationlogs.NoPacks) else CountNoPacks(inwardcancellationlogs.NoPacks) END end) as NoPacks, ArticleId from inwardcancellationlogs where DATE(created_at) < '".$startdate."' group by ArticleId) inwardcancellationlogs1 on inwardcancellationlogs1.ArticleId=a.Id left join (select NoPacks, ArticleId from outletsalesreturn where DATE(CreatedDate) < '".$startdate."') outletsalesreturn1 on outletsalesreturn1.ArticleId=a.Id left join (select outward.ArticleId, (case when outward.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(outward.NoPacks)= 0 THEN sum(outward.NoPacks) else sum(CountNoPacks(outward.NoPacks)) END end) as TotalDomesticOutQuantity, outwardnumber.Id, outwardnumber.OutwardDate from outwardnumber inner join outward on outward.OutwardNumberId=outwardnumber.Id inner join party p on p.Id=outward.PartyId where p.Id != 45 and outwardnumber.OutwardDate < '".$startdate."' group by outward.ArticleId) domesticqty1  on domesticqty1.ArticleId=a.Id left join (select outward.ArticleId, (case when outward.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(outward.NoPacks)= 0 THEN sum(outward.NoPacks) else sum(CountNoPacks(outward.NoPacks)) END end) as TotalExportOutQuantity, outwardnumber.Id, outwardnumber.OutwardDate from outwardnumber inner join outward on outward.OutwardNumberId=outwardnumber.Id inner join party p on p.Id=outward.PartyId where p.Id = 45 and outwardnumber.OutwardDate  < '".$startdate."' group by outward.ArticleId) exportqty1  on exportqty1.ArticleId=a.Id group by a.Id");
	
	 //   $data = DB::select("SELECT a.Id, a.ArticleNumber, c.Title as Category, sc.Name as Subcategory,  rs.SeriesName, rs.Series, (case when purchasereturn.ReturnNoPacks IS NULL then 0 else CASE WHEN CommaCheck(purchasereturn.ReturnNoPacks)= 0 THEN sum(purchasereturn.ReturnNoPacks) else CountNoPacks(purchasereturn.ReturnNoPacks) END end) as PurchaseReturnNoPacks, (case when salesreturn.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(salesreturn.NoPacks)= 0 THEN sum(salesreturn.NoPacks) else CountNoPacks(salesreturn.NoPacks) END end) as SalesReturnNoPacks, (case when inwardcancellationlogs.NoPacks IS NULL then 0 else inwardcancellationlogs.NoPacks end) as TotalInwardCancellation, (case when stocktransfer.TotalTransferNoPacks IS NULL then 0 else stocktransfer.TotalTransferNoPacks end) as TotalTransferNoPacks, (case when stocktransfer1.TotalConsumedNoPacks IS NULL then 0 else stocktransfer1.TotalConsumedNoPacks end) as TotalConsumedNoPacks, (case when outletsalesreturn.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(outletsalesreturn.NoPacks)= 0 THEN sum(outletsalesreturn.NoPacks) else CountNoPacks(outletsalesreturn.NoPacks) END end) as OutletSalesReturnNoPacks, (case when inward.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(inward.NoPacks)= 0 THEN sum(inward.NoPacks) else sum(CountNoPacks(inward.NoPacks)) END end) as TotalInwardQuantity, (case when domesticqty.TotalDomesticOutQuantity IS NULL then 0 else domesticqty.TotalDomesticOutQuantity end) as TotalDomesticOutQuantity, (case when exportqty.TotalExportOutQuantity IS NULL then 0 else exportqty.TotalExportOutQuantity end) as TotalExportOutQuantity, inward.InwardDate FROM `article` a left join category c on c.Id=a.CategoryId left join subcategory sc on sc.Id=a.SubCategoryId left join rangeseries rs on rs.Id=a.SeriesId left join (select * from inward where InwardDate >= '".$startdate."' AND InwardDate <= '".$enddate."') inward on inward.ArticleId=a.Id left join (select ReturnNoPacks, ArticleId from purchasereturn where DATE(CreatedDate) >= '".$startdate."' AND DATE(CreatedDate) <= '".$enddate."') purchasereturn on purchasereturn.ArticleId=a.Id left join (select NoPacks, ArticleId from salesreturn where DATE(CreatedDate) >= '".$startdate."' AND DATE(CreatedDate) <= '".$enddate."') salesreturn on salesreturn.ArticleId=a.Id left join (select (case when stocktransfer.TransferNoPacks IS NULL then 0 else CASE WHEN CommaCheck(stocktransfer.TransferNoPacks)= 0 THEN sum(stocktransfer.TransferNoPacks) else CountNoPacks(stocktransfer.TransferNoPacks) END end) as TotalTransferNoPacks, TransferArticleId from stocktransfer where DATE(created_at) >= '".$startdate."' AND DATE(created_at) <= '".$enddate."' group by TransferArticleId) stocktransfer on stocktransfer.TransferArticleId=a.Id left join (select (case when stocktransfer.ConsumedNoPacks IS NULL then 0 else CASE WHEN CommaCheck(stocktransfer.ConsumedNoPacks)= 0 THEN sum(stocktransfer.ConsumedNoPacks) else CountNoPacks(stocktransfer.ConsumedNoPacks) END end) as TotalConsumedNoPacks, ConsumedArticleId from stocktransfer where DATE(created_at) >= '".$startdate."' AND DATE(created_at) <= '".$enddate."' group by ConsumedArticleId) stocktransfer1 on stocktransfer1.ConsumedArticleId=a.Id left join (select (case when inwardcancellationlogs.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(inwardcancellationlogs.NoPacks)= 0 THEN sum(inwardcancellationlogs.NoPacks) else CountNoPacks(inwardcancellationlogs.NoPacks) END end) as NoPacks, ArticleId from inwardcancellationlogs where DATE(created_at) >= '".$startdate."' AND DATE(created_at) <= '".$enddate."' group by ArticleId) inwardcancellationlogs on inwardcancellationlogs.ArticleId=a.Id left join (select NoPacks, ArticleId from outletsalesreturn where DATE(CreatedDate) >= '".$startdate."' AND DATE(CreatedDate) <= '".$enddate."') outletsalesreturn on outletsalesreturn.ArticleId=a.Id left join (select outward.ArticleId, (case when outward.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(outward.NoPacks)= 0 THEN sum(outward.NoPacks) else sum(CountNoPacks(outward.NoPacks)) END end) as TotalDomesticOutQuantity, outwardnumber.Id, outwardnumber.OutwardDate from outwardnumber inner join outward on outward.OutwardNumberId=outwardnumber.Id inner join party p on p.Id=outward.PartyId where p.Id != 45 and outwardnumber.OutwardDate  >= '".$startdate."' AND outwardnumber.OutwardDate  <= '".$enddate."' group by outward.ArticleId) domesticqty  on domesticqty.ArticleId=a.Id left join (select outward.ArticleId, (case when outward.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(outward.NoPacks)= 0 THEN sum(outward.NoPacks) else sum(CountNoPacks(outward.NoPacks)) END end) as TotalExportOutQuantity, outwardnumber.Id, outwardnumber.OutwardDate from outwardnumber inner join outward on outward.OutwardNumberId=outwardnumber.Id inner join party p on p.Id=outward.PartyId where p.Id = 45 and outwardnumber.OutwardDate  >= '".$startdate."' AND outwardnumber.OutwardDate  <= '".$enddate."' group by outward.ArticleId) exportqty  on exportqty.ArticleId=a.Id  group by a.Id");
	//	$data_open = DB::select("SELECT a.Id, a.ArticleNumber, c.Title as Category, sc.Name as Subcategory,  rs.SeriesName, rs.Series, (case when purchasereturn1.ReturnNoPacks IS NULL then 0 else CASE WHEN CommaCheck(purchasereturn1.ReturnNoPacks)= 0 THEN sum(purchasereturn1.ReturnNoPacks) else CountNoPacks(purchasereturn1.ReturnNoPacks) END end) as PurchaseReturnNoPacks_Open, (case when salesreturn1.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(salesreturn1.NoPacks)= 0 THEN sum(salesreturn1.NoPacks) else CountNoPacks(salesreturn1.NoPacks) END end) as SalesReturnNoPacks_Open, (case when inwardcancellationlogs1.NoPacks IS NULL then 0 else inwardcancellationlogs1.NoPacks end) as TotalInwardCancellation_Open, (case when stocktransfer1.TotalTransferNoPacks IS NULL then 0 else stocktransfer1.TotalTransferNoPacks end) as TotalTransferNoPacks_Open, (case when stocktransfer2.TotalConsumedNoPacks IS NULL then 0 else stocktransfer2.TotalConsumedNoPacks end) as TotalConsumedNoPacks_Open,(case when outletsalesreturn1.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(outletsalesreturn1.NoPacks)= 0 THEN sum(outletsalesreturn1.NoPacks) else CountNoPacks(outletsalesreturn1.NoPacks) END end) as OutletSalesReturnNoPacks_Open, (case when inward1.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(inward1.NoPacks)= 0 THEN sum(inward1.NoPacks) else sum(CountNoPacks(inward1.NoPacks)) END end) as TotalInwardQuantity_Open, (case when domesticqty1.TotalDomesticOutQuantity IS NULL then 0 else domesticqty1.TotalDomesticOutQuantity end) as TotalDomesticOutQuantity_Open, (case when exportqty1.TotalExportOutQuantity IS NULL then 0 else exportqty1.TotalExportOutQuantity end) as TotalExportOutQuantity_Open, inward1.InwardDate FROM `article` a left join category c on c.Id=a.CategoryId left join subcategory sc on sc.Id=a.SubCategoryId left join rangeseries rs on rs.Id=a.SeriesId left join (select * from inward where InwardDate < '".$startdate."') inward1 on inward1.ArticleId=a.Id left join (select ReturnNoPacks, ArticleId from purchasereturn where DATE(CreatedDate) < '".$startdate."') purchasereturn1 on purchasereturn1.ArticleId=a.Id left join (select NoPacks, ArticleId from salesreturn where DATE(CreatedDate) < '".$startdate."') salesreturn1 on salesreturn1.ArticleId=a.Id left join (select (case when stocktransfer.TransferNoPacks IS NULL then 0 else CASE WHEN CommaCheck(stocktransfer.TransferNoPacks)= 0 THEN sum(stocktransfer.TransferNoPacks) else CountNoPacks(stocktransfer.TransferNoPacks) END end) as TotalTransferNoPacks, TransferArticleId from stocktransfer where DATE(created_at) < '".$startdate."' group by TransferArticleId) stocktransfer1 on stocktransfer1.TransferArticleId=a.Id left join (select (case when stocktransfer.ConsumedNoPacks IS NULL then 0 else CASE WHEN CommaCheck(stocktransfer.ConsumedNoPacks)= 0 THEN sum(stocktransfer.ConsumedNoPacks) else CountNoPacks(stocktransfer.ConsumedNoPacks) END end) as TotalConsumedNoPacks, ConsumedArticleId from stocktransfer where DATE(created_at) < '".$startdate."' group by ConsumedArticleId) stocktransfer2 on stocktransfer2.ConsumedArticleId=a.Id left join (select (case when inwardcancellationlogs.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(inwardcancellationlogs.NoPacks)= 0 THEN sum(inwardcancellationlogs.NoPacks) else CountNoPacks(inwardcancellationlogs.NoPacks) END end) as NoPacks, ArticleId from inwardcancellationlogs where DATE(created_at) < '".$startdate."' group by ArticleId) inwardcancellationlogs1 on inwardcancellationlogs1.ArticleId=a.Id left join (select NoPacks, ArticleId from outletsalesreturn where DATE(CreatedDate) < '".$startdate."') outletsalesreturn1 on outletsalesreturn1.ArticleId=a.Id left join (select outward.ArticleId, (case when outward.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(outward.NoPacks)= 0 THEN sum(outward.NoPacks) else sum(CountNoPacks(outward.NoPacks)) END end) as TotalDomesticOutQuantity, outwardnumber.Id, outwardnumber.OutwardDate from outwardnumber inner join outward on outward.OutwardNumberId=outwardnumber.Id inner join party p on p.Id=outward.PartyId where p.Id != 45 and outwardnumber.OutwardDate < '".$startdate."' group by outward.ArticleId) domesticqty1  on domesticqty1.ArticleId=a.Id left join (select outward.ArticleId, (case when outward.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(outward.NoPacks)= 0 THEN sum(outward.NoPacks) else sum(CountNoPacks(outward.NoPacks)) END end) as TotalExportOutQuantity, outwardnumber.Id, outwardnumber.OutwardDate from outwardnumber inner join outward on outward.OutwardNumberId=outwardnumber.Id inner join party p on p.Id=outward.PartyId where p.Id = 45 and outwardnumber.OutwardDate  < '".$startdate."' group by outward.ArticleId) exportqty1  on exportqty1.ArticleId=a.Id group by a.Id");

//         $data = DB::select("SELECT a.Id, a.ArticleNumber, c.Title as Category, sc.Name as Subcategory,  rs.SeriesName, rs.Series, (case when purchasereturn.ReturnNoPacks IS NULL then 0 else purchasereturn.ReturnNoPacks end) as PurchaseReturnNoPacks, (case when salesreturn.NoPacks IS NULL then 0 else salesreturn.NoPacks end) as SalesReturnNoPacks, (case when inwardcancellationlogs.NoPacks IS NULL then 0 else inwardcancellationlogs.NoPacks end) as TotalInwardCancellation, (case when stocktransfer.TotalTransferNoPacks IS NULL then 0 else stocktransfer.TotalTransferNoPacks end) as TotalTransferNoPacks, (case when stocktransfer1.TotalConsumedNoPacks IS NULL then 0 else stocktransfer1.TotalConsumedNoPacks end) as TotalConsumedNoPacks, (case when outletsalesreturn.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(outletsalesreturn.NoPacks)= 0 THEN sum(outletsalesreturn.NoPacks) else CountNoPacks(outletsalesreturn.NoPacks) END end) as OutletSalesReturnNoPacks, (case when inward.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(inward.NoPacks)= 0 THEN sum(inward.NoPacks) else sum(CountNoPacks(inward.NoPacks)) END end) as TotalInwardQuantity, (case when domesticqty.TotalDomesticOutQuantity IS NULL then 0 else domesticqty.TotalDomesticOutQuantity end) as TotalDomesticOutQuantity, (case when exportqty.TotalExportOutQuantity IS NULL then 0 else exportqty.TotalExportOutQuantity end) as TotalExportOutQuantity, inward.InwardDate FROM `article` a left join category c on c.Id=a.CategoryId left join subcategory sc on sc.Id=a.SubCategoryId left join rangeseries rs on rs.Id=a.SeriesId left join (select * from inward where InwardDate >= '".$startdate."' AND InwardDate <=  '".$enddate."') inward on inward.ArticleId=a.Id left join (select (case when purchasereturn.ReturnNoPacks IS NULL then 0 else CASE WHEN CommaCheck(purchasereturn.ReturnNoPacks)= 0 THEN sum(purchasereturn.ReturnNoPacks) else sum(CountNoPacks(purchasereturn.ReturnNoPacks)) END end) as ReturnNoPacks, ArticleId from purchasereturn where DATE(CreatedDate) >= '".$startdate."' AND DATE(CreatedDate) <= '".$enddate."' group by ArticleId) purchasereturn on purchasereturn.ArticleId=a.Id left join (select (case when salesreturn.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(salesreturn.NoPacks)= 0 THEN sum(salesreturn.NoPacks) else sum(CountNoPacks(salesreturn.NoPacks)) END end) as NoPacks, ArticleId from salesreturn where DATE(CreatedDate) >= '".$startdate."' AND DATE(CreatedDate) <= '".$enddate."' group by ArticleId) salesreturn on salesreturn.ArticleId=a.Id left join (select (case when stocktransfer.TransferNoPacks IS NULL then 0 else CASE WHEN CommaCheck(stocktransfer.TransferNoPacks)= 0 THEN sum(stocktransfer.TransferNoPacks) else sum(CountNoPacks(stocktransfer.TransferNoPacks)) END end) as TotalTransferNoPacks, TransferArticleId from stocktransfer where DATE(created_at) >= '".$startdate."' AND DATE(created_at) <= '".$enddate."' group by TransferArticleId) stocktransfer on stocktransfer.TransferArticleId=a.Id left join (select (case when stocktransfer.ConsumedNoPacks IS NULL then 0 else CASE WHEN CommaCheck(stocktransfer.ConsumedNoPacks)= 0 THEN sum(stocktransfer.ConsumedNoPacks) else sum(CountNoPacks(stocktransfer.ConsumedNoPacks)) END end) as TotalConsumedNoPacks, ConsumedArticleId from stocktransfer where DATE(created_at) >= '".$startdate."' AND DATE(created_at) <= '".$enddate."' group by ConsumedArticleId) stocktransfer1 on stocktransfer1.ConsumedArticleId=a.Id left join (select (case when inwardcancellationlogs.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(inwardcancellationlogs.NoPacks)= 0 THEN sum(inwardcancellationlogs.NoPacks) else CountNoPacks(inwardcancellationlogs.NoPacks) END end) as NoPacks, ArticleId from inwardcancellationlogs where DATE(created_at) >= '".$startdate."' AND DATE(created_at) <= '".$enddate."' group by ArticleId) inwardcancellationlogs on inwardcancellationlogs.ArticleId=a.Id left join (select NoPacks, ArticleId from outletsalesreturn where DATE(CreatedDate) >= '".$startdate."' AND DATE(CreatedDate) <= '".$enddate."') outletsalesreturn on outletsalesreturn.ArticleId=a.Id left join (select outward.ArticleId, (case when outward.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(outward.NoPacks)= 0 THEN sum(outward.NoPacks) else sum(CountNoPacks(outward.NoPacks)) END end) as TotalDomesticOutQuantity, outwardnumber.Id, outwardnumber.OutwardDate from outwardnumber inner join outward on outward.OutwardNumberId=outwardnumber.Id inner join party p on p.Id=outward.PartyId where p.Id != 45 and outwardnumber.OutwardDate  >= '".$startdate."' AND outwardnumber.OutwardDate  <= '".$enddate."' group by outward.ArticleId) domesticqty  on domesticqty.ArticleId=a.Id left join (select outward.ArticleId, (case when outward.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(outward.NoPacks)= 0 THEN sum(outward.NoPacks) else sum(CountNoPacks(outward.NoPacks)) END end) as TotalExportOutQuantity, outwardnumber.Id, outwardnumber.OutwardDate from outwardnumber inner join outward on outward.OutwardNumberId=outwardnumber.Id inner join party p on p.Id=outward.PartyId where p.Id = 45 and outwardnumber.OutwardDate  >= '".$startdate."' AND outwardnumber.OutwardDate  <= '".$enddate."' group by outward.ArticleId) exportqty  on exportqty.ArticleId=a.Id  group by a.Id");
// 		$data_open = DB::select("SELECT a.Id, a.ArticleNumber, c.Title as Category, sc.Name as Subcategory,  rs.SeriesName, rs.Series, (case when purchasereturn1.ReturnNoPacks IS NULL then 0 else purchasereturn1.ReturnNoPacks end) as PurchaseReturnNoPacks_Open, (case when salesreturn1.NoPacks IS NULL then 0 else salesreturn1.NoPacks end) as SalesReturnNoPacks_Open, (case when inwardcancellationlogs1.NoPacks IS NULL then 0 else inwardcancellationlogs1.NoPacks end) as TotalInwardCancellation_Open, (case when stocktransfer1.TotalTransferNoPacks IS NULL then 0 else stocktransfer1.TotalTransferNoPacks end) as TotalTransferNoPacks_Open, (case when stocktransfer2.TotalConsumedNoPacks IS NULL then 0 else stocktransfer2.TotalConsumedNoPacks end) as TotalConsumedNoPacks_Open,(case when outletsalesreturn1.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(outletsalesreturn1.NoPacks)= 0 THEN sum(outletsalesreturn1.NoPacks) else CountNoPacks(outletsalesreturn1.NoPacks) END end) as OutletSalesReturnNoPacks_Open, (case when inward1.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(inward1.NoPacks)= 0 THEN sum(inward1.NoPacks) else sum(CountNoPacks(inward1.NoPacks)) END end) as TotalInwardQuantity_Open, (case when domesticqty1.TotalDomesticOutQuantity IS NULL then 0 else domesticqty1.TotalDomesticOutQuantity end) as TotalDomesticOutQuantity_Open, (case when exportqty1.TotalExportOutQuantity IS NULL then 0 else exportqty1.TotalExportOutQuantity end) as TotalExportOutQuantity_Open, inward1.InwardDate FROM `article` a left join category c on c.Id=a.CategoryId left join subcategory sc on sc.Id=a.SubCategoryId left join rangeseries rs on rs.Id=a.SeriesId left join (select * from inward where InwardDate < '".$startdate."') inward1 on inward1.ArticleId=a.Id left join (select (case when purchasereturn.ReturnNoPacks IS NULL then 0 else CASE WHEN CommaCheck(purchasereturn.ReturnNoPacks)= 0 THEN sum(purchasereturn.ReturnNoPacks) else sum(CountNoPacks(purchasereturn.ReturnNoPacks)) END end) as ReturnNoPacks, ArticleId from purchasereturn where DATE(CreatedDate) < '".$startdate."' group by ArticleId) purchasereturn1 on purchasereturn1.ArticleId=a.Id left join (select (case when salesreturn.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(salesreturn.NoPacks)= 0 THEN sum(salesreturn.NoPacks) else sum(CountNoPacks(salesreturn.NoPacks)) END end) as NoPacks, ArticleId from salesreturn where DATE(CreatedDate) < '".$startdate."' group by ArticleId) salesreturn1 on salesreturn1.ArticleId=a.Id left join (select (case when stocktransfer.TransferNoPacks IS NULL then 0 else CASE WHEN CommaCheck(stocktransfer.TransferNoPacks)= 0 THEN sum(stocktransfer.TransferNoPacks) else sum(CountNoPacks(stocktransfer.TransferNoPacks)) END end) as TotalTransferNoPacks, TransferArticleId from stocktransfer where DATE(created_at) < '".$startdate."' group by TransferArticleId) stocktransfer1 on stocktransfer1.TransferArticleId=a.Id left join (select (case when stocktransfer.ConsumedNoPacks IS NULL then 0 else CASE WHEN CommaCheck(stocktransfer.ConsumedNoPacks)= 0 THEN sum(stocktransfer.ConsumedNoPacks) else sum(CountNoPacks(stocktransfer.ConsumedNoPacks)) END end) as TotalConsumedNoPacks, ConsumedArticleId from stocktransfer where DATE(created_at) < '".$startdate."' group by ConsumedArticleId) stocktransfer2 on stocktransfer2.ConsumedArticleId=a.Id left join (select (case when inwardcancellationlogs.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(inwardcancellationlogs.NoPacks)= 0 THEN sum(inwardcancellationlogs.NoPacks) else CountNoPacks(inwardcancellationlogs.NoPacks) END end) as NoPacks, ArticleId from inwardcancellationlogs where DATE(created_at) < '".$startdate."' group by ArticleId) inwardcancellationlogs1 on inwardcancellationlogs1.ArticleId=a.Id left join (select NoPacks, ArticleId from outletsalesreturn where DATE(CreatedDate) < '".$startdate."') outletsalesreturn1 on outletsalesreturn1.ArticleId=a.Id left join (select outward.ArticleId, (case when outward.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(outward.NoPacks)= 0 THEN sum(outward.NoPacks) else sum(CountNoPacks(outward.NoPacks)) END end) as TotalDomesticOutQuantity, outwardnumber.Id, outwardnumber.OutwardDate from outwardnumber inner join outward on outward.OutwardNumberId=outwardnumber.Id inner join party p on p.Id=outward.PartyId where p.Id != 45 and outwardnumber.OutwardDate < '".$startdate."' group by outward.ArticleId) domesticqty1  on domesticqty1.ArticleId=a.Id left join (select outward.ArticleId, (case when outward.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(outward.NoPacks)= 0 THEN sum(outward.NoPacks) else sum(CountNoPacks(outward.NoPacks)) END end) as TotalExportOutQuantity, outwardnumber.Id, outwardnumber.OutwardDate from outwardnumber inner join outward on outward.OutwardNumberId=outwardnumber.Id inner join party p on p.Id=outward.PartyId where p.Id = 45 and outwardnumber.OutwardDate  < '".$startdate."' group by outward.ArticleId) exportqty1  on exportqty1.ArticleId=a.Id group by a.Id");
		
	//	$data = DB::select("SELECT a.Id, a.ArticleNumber, c.Title as Category, sc.Name as Subcategory,  rs.SeriesName, rs.Series, (case when purchasereturn.ReturnNoPacks IS NULL then 0 else purchasereturn.ReturnNoPacks end) as PurchaseReturnNoPacks, (case when salesreturn.NoPacks IS NULL then 0 else salesreturn.NoPacks end) as SalesReturnNoPacks, (case when inwardcancellationlogs.NoPacks IS NULL then 0 else inwardcancellationlogs.NoPacks end) as TotalInwardCancellation, (case when stocktransfer.TotalTransferNoPacks IS NULL then 0 else stocktransfer.TotalTransferNoPacks end) as TotalTransferNoPacks, (case when stocktransfer1.TotalConsumedNoPacks IS NULL then 0 else stocktransfer1.TotalConsumedNoPacks end) as TotalConsumedNoPacks, (case when outletsalesreturn.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(outletsalesreturn.NoPacks)= 0 THEN sum(outletsalesreturn.NoPacks) else CountNoPacks(outletsalesreturn.NoPacks) END end) as OutletSalesReturnNoPacks, (case when inward.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(inward.NoPacks)= 0 THEN sum(inward.NoPacks) else sum(CountNoPacks(inward.NoPacks)) END end) as TotalInwardQuantity, (case when domesticqty.TotalDomesticOutQuantity IS NULL then 0 else domesticqty.TotalDomesticOutQuantity end) as TotalDomesticOutQuantity, (case when exportqty.TotalExportOutQuantity IS NULL then 0 else exportqty.TotalExportOutQuantity end) as TotalExportOutQuantity, inward.InwardDate FROM `article` a left join category c on c.Id=a.CategoryId left join subcategory sc on sc.Id=a.SubCategoryId left join rangeseries rs on rs.Id=a.SeriesId left join (select * from inward where InwardDate >= '".$startdate."' AND InwardDate <=  '".$enddate."') inward on inward.ArticleId=a.Id left join (select (case when purchasereturn.ReturnNoPacks IS NULL then 0 else CASE WHEN CommaCheck(purchasereturn.ReturnNoPacks)= 0 THEN sum(purchasereturn.ReturnNoPacks) else sum(CountNoPacks(purchasereturn.ReturnNoPacks)) END end) as ReturnNoPacks, ArticleId from purchasereturn where DATE(CreatedDate) >= '".$startdate."' AND DATE(CreatedDate) <= '".$enddate."' group by ArticleId) purchasereturn on purchasereturn.ArticleId=a.Id left join (select (case when salesreturn.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(salesreturn.NoPacks)= 0 THEN sum(salesreturn.NoPacks) else sum(CountNoPacks(salesreturn.NoPacks)) END end) as NoPacks, ArticleId from salesreturn where DATE(CreatedDate) >= '".$startdate."' AND DATE(CreatedDate) <= '".$enddate."' group by ArticleId) salesreturn on salesreturn.ArticleId=a.Id left join (select (case when st.TransferNoPacks IS NULL then 0 else CASE WHEN CommaCheck(st.TransferNoPacks)= 0 THEN sum(st.TransferNoPacks) else sum(CountNoPacks(st.TransferNoPacks)) END end) as TotalTransferNoPacks, st.TransferArticleId from stocktransfer st inner join stocktransfernumber stn on stn.Id=st.StocktransferNumberId where DATE(stn.StocktransferDate) >=  '".$startdate."' AND DATE(stn.StocktransferDate) <= '".$enddate."' group by TransferArticleId) stocktransfer on stocktransfer.TransferArticleId=a.Id left join (select (case when stocktransfer.ConsumedNoPacks IS NULL then 0 else CASE WHEN CommaCheck(stocktransfer.ConsumedNoPacks)= 0 THEN sum(stocktransfer.ConsumedNoPacks) else sum(CountNoPacks(stocktransfer.ConsumedNoPacks)) END end) as TotalConsumedNoPacks, ConsumedArticleId from stocktransfer where DATE(created_at) >= '".$startdate."' AND DATE(created_at) <= '".$enddate."' group by ConsumedArticleId) stocktransfer1 on stocktransfer1.ConsumedArticleId=a.Id left join (select (case when inwardcancellationlogs.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(inwardcancellationlogs.NoPacks)= 0 THEN sum(inwardcancellationlogs.NoPacks) else CountNoPacks(inwardcancellationlogs.NoPacks) END end) as NoPacks, ArticleId from inwardcancellationlogs where DATE(created_at) >= '".$startdate."' AND DATE(created_at) <= '".$enddate."' group by ArticleId) inwardcancellationlogs on inwardcancellationlogs.ArticleId=a.Id left join (select NoPacks, ArticleId from outletsalesreturn where DATE(CreatedDate) >= '".$startdate."' AND DATE(CreatedDate) <= '".$enddate."') outletsalesreturn on outletsalesreturn.ArticleId=a.Id left join (select outward.ArticleId, (case when outward.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(outward.NoPacks)= 0 THEN sum(outward.NoPacks) else sum(CountNoPacks(outward.NoPacks)) END end) as TotalDomesticOutQuantity, outwardnumber.Id, outwardnumber.OutwardDate from outwardnumber inner join outward on outward.OutwardNumberId=outwardnumber.Id inner join party p on p.Id=outward.PartyId where p.Id != 45 and outwardnumber.OutwardDate  >= '".$startdate."' AND outwardnumber.OutwardDate  <= '".$enddate."' group by outward.ArticleId) domesticqty  on domesticqty.ArticleId=a.Id left join (select outward.ArticleId, (case when outward.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(outward.NoPacks)= 0 THEN sum(outward.NoPacks) else sum(CountNoPacks(outward.NoPacks)) END end) as TotalExportOutQuantity, outwardnumber.Id, outwardnumber.OutwardDate from outwardnumber inner join outward on outward.OutwardNumberId=outwardnumber.Id inner join party p on p.Id=outward.PartyId where p.Id = 45 and outwardnumber.OutwardDate  >= '".$startdate."' AND outwardnumber.OutwardDate  <= '".$enddate."' group by outward.ArticleId) exportqty  on exportqty.ArticleId=a.Id  group by a.Id");
	//	$data_open = DB::select("SELECT a.Id, a.ArticleNumber, c.Title as Category, sc.Name as Subcategory,  rs.SeriesName, rs.Series, (case when purchasereturn1.ReturnNoPacks IS NULL then 0 else purchasereturn1.ReturnNoPacks end) as PurchaseReturnNoPacks_Open, (case when salesreturn1.NoPacks IS NULL then 0 else salesreturn1.NoPacks end) as SalesReturnNoPacks_Open, (case when inwardcancellationlogs1.NoPacks IS NULL then 0 else inwardcancellationlogs1.NoPacks end) as TotalInwardCancellation_Open, (case when stocktransfer1.TotalTransferNoPacks IS NULL then 0 else stocktransfer1.TotalTransferNoPacks end) as TotalTransferNoPacks_Open, (case when stocktransfer2.TotalConsumedNoPacks IS NULL then 0 else stocktransfer2.TotalConsumedNoPacks end) as TotalConsumedNoPacks_Open,(case when outletsalesreturn1.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(outletsalesreturn1.NoPacks)= 0 THEN sum(outletsalesreturn1.NoPacks) else CountNoPacks(outletsalesreturn1.NoPacks) END end) as OutletSalesReturnNoPacks_Open, (case when inward1.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(inward1.NoPacks)= 0 THEN sum(inward1.NoPacks) else sum(CountNoPacks(inward1.NoPacks)) END end) as TotalInwardQuantity_Open, (case when domesticqty1.TotalDomesticOutQuantity IS NULL then 0 else domesticqty1.TotalDomesticOutQuantity end) as TotalDomesticOutQuantity_Open, (case when exportqty1.TotalExportOutQuantity IS NULL then 0 else exportqty1.TotalExportOutQuantity end) as TotalExportOutQuantity_Open, inward1.InwardDate FROM `article` a left join category c on c.Id=a.CategoryId left join subcategory sc on sc.Id=a.SubCategoryId left join rangeseries rs on rs.Id=a.SeriesId left join (select * from inward where InwardDate < '".$startdate."') inward1 on inward1.ArticleId=a.Id left join (select (case when purchasereturn.ReturnNoPacks IS NULL then 0 else CASE WHEN CommaCheck(purchasereturn.ReturnNoPacks)= 0 THEN sum(purchasereturn.ReturnNoPacks) else sum(CountNoPacks(purchasereturn.ReturnNoPacks)) END end) as ReturnNoPacks, ArticleId from purchasereturn where DATE(CreatedDate) < '".$startdate."' group by ArticleId) purchasereturn1 on purchasereturn1.ArticleId=a.Id left join (select (case when salesreturn.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(salesreturn.NoPacks)= 0 THEN sum(salesreturn.NoPacks) else sum(CountNoPacks(salesreturn.NoPacks)) END end) as NoPacks, ArticleId from salesreturn where DATE(CreatedDate) < '".$startdate."' group by ArticleId) salesreturn1 on salesreturn1.ArticleId=a.Id left join (select (case when st.TransferNoPacks IS NULL then 0 else CASE WHEN CommaCheck(st.TransferNoPacks)= 0 THEN sum(st.TransferNoPacks) else sum(CountNoPacks(st.TransferNoPacks)) END end) as TotalTransferNoPacks, st.TransferArticleId from stocktransfer st inner join stocktransfernumber stn on stn.Id=st.StocktransferNumberId where DATE(stn.StocktransferDate) < '".$startdate."' group by TransferArticleId) stocktransfer1 on stocktransfer1.TransferArticleId=a.Id left join (select (case when stocktransfer.ConsumedNoPacks IS NULL then 0 else CASE WHEN CommaCheck(stocktransfer.ConsumedNoPacks)= 0 THEN sum(stocktransfer.ConsumedNoPacks) else sum(CountNoPacks(stocktransfer.ConsumedNoPacks)) END end) as TotalConsumedNoPacks, ConsumedArticleId from stocktransfer where DATE(created_at) < '".$startdate."' group by ConsumedArticleId) stocktransfer2 on stocktransfer2.ConsumedArticleId=a.Id left join (select (case when inwardcancellationlogs.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(inwardcancellationlogs.NoPacks)= 0 THEN sum(inwardcancellationlogs.NoPacks) else CountNoPacks(inwardcancellationlogs.NoPacks) END end) as NoPacks, ArticleId from inwardcancellationlogs where DATE(created_at) < '".$startdate."' group by ArticleId) inwardcancellationlogs1 on inwardcancellationlogs1.ArticleId=a.Id left join (select NoPacks, ArticleId from outletsalesreturn where DATE(CreatedDate) < '".$startdate."') outletsalesreturn1 on outletsalesreturn1.ArticleId=a.Id left join (select outward.ArticleId, (case when outward.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(outward.NoPacks)= 0 THEN sum(outward.NoPacks) else sum(CountNoPacks(outward.NoPacks)) END end) as TotalDomesticOutQuantity, outwardnumber.Id, outwardnumber.OutwardDate from outwardnumber inner join outward on outward.OutwardNumberId=outwardnumber.Id inner join party p on p.Id=outward.PartyId where p.Id != 45 and outwardnumber.OutwardDate < '".$startdate."' group by outward.ArticleId) domesticqty1  on domesticqty1.ArticleId=a.Id left join (select outward.ArticleId, (case when outward.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(outward.NoPacks)= 0 THEN sum(outward.NoPacks) else sum(CountNoPacks(outward.NoPacks)) END end) as TotalExportOutQuantity, outwardnumber.Id, outwardnumber.OutwardDate from outwardnumber inner join outward on outward.OutwardNumberId=outwardnumber.Id inner join party p on p.Id=outward.PartyId where p.Id = 45 and outwardnumber.OutwardDate  < '".$startdate."' group by outward.ArticleId) exportqty1  on exportqty1.ArticleId=a.Id group by a.Id");
	
		$data = DB::select("SELECT a.Id, a.ArticleNumber, c.Title as Category, sc.Name as Subcategory,  rs.SeriesName, rs.Series, (case when purchasereturn.ReturnNoPacks IS NULL then 0 else purchasereturn.ReturnNoPacks end) as PurchaseReturnNoPacks, (case when stockshortage.NoPacks IS NULL then 0 else stockshortage.NoPacks end) as stockshortage, (case when salesreturn.NoPacks IS NULL then 0 else salesreturn.NoPacks end) as SalesReturnNoPacks, (case when inwardcancellationlogs.NoPacks IS NULL then 0 else inwardcancellationlogs.NoPacks end) as TotalInwardCancellation, (case when stocktransfer.TotalTransferNoPacks IS NULL then 0 else stocktransfer.TotalTransferNoPacks end) as TotalTransferNoPacks, (case when stocktransfer1.TotalConsumedNoPacks IS NULL then 0 else stocktransfer1.TotalConsumedNoPacks end) as TotalConsumedNoPacks, (case when outletsalesreturn.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(outletsalesreturn.NoPacks)= 0 THEN sum(outletsalesreturn.NoPacks) else CountNoPacks(outletsalesreturn.NoPacks) END end) as OutletSalesReturnNoPacks, (case when inward.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(inward.NoPacks)= 0 THEN sum(inward.NoPacks) else sum(CountNoPacks(inward.NoPacks)) END end) as TotalInwardQuantity, (case when domesticqty.TotalDomesticOutQuantity IS NULL then 0 else domesticqty.TotalDomesticOutQuantity end) as TotalDomesticOutQuantity, (case when exportqty.TotalExportOutQuantity IS NULL then 0 else exportqty.TotalExportOutQuantity end) as TotalExportOutQuantity, inward.InwardDate FROM `article` a left join category c on c.Id=a.CategoryId left join subcategory sc on sc.Id=a.SubCategoryId left join rangeseries rs on rs.Id=a.SeriesId left join (select * from inward where InwardDate >= '".$startdate."' AND InwardDate <=  '".$enddate."') inward on inward.ArticleId=a.Id left join (select (case when purchasereturn.ReturnNoPacks IS NULL then 0 else CASE WHEN CommaCheck(purchasereturn.ReturnNoPacks)= 0 THEN sum(purchasereturn.ReturnNoPacks) else sum(CountNoPacks(purchasereturn.ReturnNoPacks)) END end) as ReturnNoPacks, ArticleId from purchasereturn where DATE(CreatedDate) >= '".$startdate."' AND DATE(CreatedDate) <= '".$enddate."' group by ArticleId) purchasereturn on purchasereturn.ArticleId=a.Id left join (select (case when stockshortage.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(stockshortage.NoPacks)= 0 THEN sum(stockshortage.NoPacks) else sum(CountNoPacks(stockshortage.NoPacks)) END end) as NoPacks, ArticleId from stockshortage where DATE(created_at) >= '".$startdate."' AND DATE(created_at) <= '".$enddate."' group by ArticleId) stockshortage on stockshortage.ArticleId=a.Id left join (select (case when salesreturn.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(salesreturn.NoPacks)= 0 THEN sum(salesreturn.NoPacks) else sum(CountNoPacks(salesreturn.NoPacks)) END end) as NoPacks, ArticleId from salesreturn where DATE(CreatedDate) >= '".$startdate."' AND DATE(CreatedDate) <= '".$enddate."' group by ArticleId) salesreturn on salesreturn.ArticleId=a.Id left join (select (case when st.TransferNoPacks IS NULL then 0 else CASE WHEN CommaCheck(st.TransferNoPacks)= 0 THEN sum(st.TransferNoPacks) else sum(CountNoPacks(st.TransferNoPacks)) END end) as TotalTransferNoPacks, st.TransferArticleId from stocktransfer st inner join stocktransfernumber stn on stn.Id=st.StocktransferNumberId where DATE(stn.StocktransferDate) >=  '".$startdate."' AND DATE(stn.StocktransferDate) <= '".$enddate."' group by TransferArticleId) stocktransfer on stocktransfer.TransferArticleId=a.Id left join (select (case when stocktransfer.ConsumedNoPacks IS NULL then 0 else CASE WHEN CommaCheck(stocktransfer.ConsumedNoPacks)= 0 THEN sum(stocktransfer.ConsumedNoPacks) else sum(CountNoPacks(stocktransfer.ConsumedNoPacks)) END end) as TotalConsumedNoPacks, ConsumedArticleId from stocktransfer where DATE(created_at) >= '".$startdate."' AND DATE(created_at) <= '".$enddate."' group by ConsumedArticleId) stocktransfer1 on stocktransfer1.ConsumedArticleId=a.Id left join (select (case when inwardcancellationlogs.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(inwardcancellationlogs.NoPacks)= 0 THEN sum(inwardcancellationlogs.NoPacks) else CountNoPacks(inwardcancellationlogs.NoPacks) END end) as NoPacks, ArticleId from inwardcancellationlogs where DATE(created_at) >= '".$startdate."' AND DATE(created_at) <= '".$enddate."' group by ArticleId) inwardcancellationlogs on inwardcancellationlogs.ArticleId=a.Id left join (select NoPacks, ArticleId from outletsalesreturn where DATE(CreatedDate) >= '".$startdate."' AND DATE(CreatedDate) <= '".$enddate."') outletsalesreturn on outletsalesreturn.ArticleId=a.Id left join (select outward.ArticleId, (case when outward.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(outward.NoPacks)= 0 THEN sum(outward.NoPacks) else sum(CountNoPacks(outward.NoPacks)) END end) as TotalDomesticOutQuantity, outwardnumber.Id, outwardnumber.OutwardDate from outwardnumber inner join outward on outward.OutwardNumberId=outwardnumber.Id inner join party p on p.Id=outward.PartyId where p.Id != 45 and outwardnumber.OutwardDate  >= '".$startdate."' AND outwardnumber.OutwardDate  <= '".$enddate."' group by outward.ArticleId) domesticqty  on domesticqty.ArticleId=a.Id left join (select outward.ArticleId, (case when outward.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(outward.NoPacks)= 0 THEN sum(outward.NoPacks) else sum(CountNoPacks(outward.NoPacks)) END end) as TotalExportOutQuantity, outwardnumber.Id, outwardnumber.OutwardDate from outwardnumber inner join outward on outward.OutwardNumberId=outwardnumber.Id inner join party p on p.Id=outward.PartyId where p.Id = 45 and outwardnumber.OutwardDate  >= '".$startdate."' AND outwardnumber.OutwardDate  <= '".$enddate."' group by outward.ArticleId) exportqty  on exportqty.ArticleId=a.Id  group by a.Id");
		$data_open = DB::select("SELECT a.Id, a.ArticleNumber, c.Title as Category, sc.Name as Subcategory,  rs.SeriesName, rs.Series, (case when purchasereturn1.ReturnNoPacks IS NULL then 0 else purchasereturn1.ReturnNoPacks end) as PurchaseReturnNoPacks_Open, (case when stockshortage.NoPacks IS NULL then 0 else stockshortage.NoPacks end) as stockshortage_Open, (case when salesreturn1.NoPacks IS NULL then 0 else salesreturn1.NoPacks end) as SalesReturnNoPacks_Open, (case when inwardcancellationlogs1.NoPacks IS NULL then 0 else inwardcancellationlogs1.NoPacks end) as TotalInwardCancellation_Open, (case when stocktransfer1.TotalTransferNoPacks IS NULL then 0 else stocktransfer1.TotalTransferNoPacks end) as TotalTransferNoPacks_Open, (case when stocktransfer2.TotalConsumedNoPacks IS NULL then 0 else stocktransfer2.TotalConsumedNoPacks end) as TotalConsumedNoPacks_Open,(case when outletsalesreturn1.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(outletsalesreturn1.NoPacks)= 0 THEN sum(outletsalesreturn1.NoPacks) else CountNoPacks(outletsalesreturn1.NoPacks) END end) as OutletSalesReturnNoPacks_Open, (case when inward1.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(inward1.NoPacks)= 0 THEN sum(inward1.NoPacks) else sum(CountNoPacks(inward1.NoPacks)) END end) as TotalInwardQuantity_Open, (case when domesticqty1.TotalDomesticOutQuantity IS NULL then 0 else domesticqty1.TotalDomesticOutQuantity end) as TotalDomesticOutQuantity_Open, (case when exportqty1.TotalExportOutQuantity IS NULL then 0 else exportqty1.TotalExportOutQuantity end) as TotalExportOutQuantity_Open, inward1.InwardDate FROM `article` a left join category c on c.Id=a.CategoryId left join subcategory sc on sc.Id=a.SubCategoryId left join rangeseries rs on rs.Id=a.SeriesId left join (select * from inward where InwardDate < '".$startdate."') inward1 on inward1.ArticleId=a.Id left join (select (case when purchasereturn.ReturnNoPacks IS NULL then 0 else CASE WHEN CommaCheck(purchasereturn.ReturnNoPacks)= 0 THEN sum(purchasereturn.ReturnNoPacks) else sum(CountNoPacks(purchasereturn.ReturnNoPacks)) END end) as ReturnNoPacks, ArticleId from purchasereturn where DATE(CreatedDate) < '".$startdate."' group by ArticleId) purchasereturn1 on purchasereturn1.ArticleId=a.Id left join (select (case when salesreturn.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(salesreturn.NoPacks)= 0 THEN sum(salesreturn.NoPacks) else sum(CountNoPacks(salesreturn.NoPacks)) END end) as NoPacks, ArticleId from salesreturn where DATE(CreatedDate) < '".$startdate."' group by ArticleId) salesreturn1 on salesreturn1.ArticleId=a.Id left join (select (case when st.TransferNoPacks IS NULL then 0 else CASE WHEN CommaCheck(st.TransferNoPacks)= 0 THEN sum(st.TransferNoPacks) else sum(CountNoPacks(st.TransferNoPacks)) END end) as TotalTransferNoPacks, st.TransferArticleId from stocktransfer st inner join stocktransfernumber stn on stn.Id=st.StocktransferNumberId where DATE(stn.StocktransferDate) < '".$startdate."' group by TransferArticleId) stocktransfer1 on stocktransfer1.TransferArticleId=a.Id left join (select (case when stocktransfer.ConsumedNoPacks IS NULL then 0 else CASE WHEN CommaCheck(stocktransfer.ConsumedNoPacks)= 0 THEN sum(stocktransfer.ConsumedNoPacks) else sum(CountNoPacks(stocktransfer.ConsumedNoPacks)) END end) as TotalConsumedNoPacks, ConsumedArticleId from stocktransfer where DATE(created_at) < '".$startdate."' group by ConsumedArticleId) stocktransfer2 on stocktransfer2.ConsumedArticleId=a.Id left join (select (case when stockshortage.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(stockshortage.NoPacks)= 0 THEN sum(stockshortage.NoPacks) else sum(CountNoPacks(stockshortage.NoPacks)) END end) as NoPacks, ArticleId from stockshortage where DATE(created_at) < '".$startdate."' group by ArticleId) stockshortage on stockshortage.ArticleId=a.Id left join (select (case when inwardcancellationlogs.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(inwardcancellationlogs.NoPacks)= 0 THEN sum(inwardcancellationlogs.NoPacks) else CountNoPacks(inwardcancellationlogs.NoPacks) END end) as NoPacks, ArticleId from inwardcancellationlogs where DATE(created_at) < '".$startdate."' group by ArticleId) inwardcancellationlogs1 on inwardcancellationlogs1.ArticleId=a.Id left join (select NoPacks, ArticleId from outletsalesreturn where DATE(CreatedDate) < '".$startdate."') outletsalesreturn1 on outletsalesreturn1.ArticleId=a.Id left join (select outward.ArticleId, (case when outward.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(outward.NoPacks)= 0 THEN sum(outward.NoPacks) else sum(CountNoPacks(outward.NoPacks)) END end) as TotalDomesticOutQuantity, outwardnumber.Id, outwardnumber.OutwardDate from outwardnumber inner join outward on outward.OutwardNumberId=outwardnumber.Id inner join party p on p.Id=outward.PartyId where p.Id != 45 and outwardnumber.OutwardDate < '".$startdate."' group by outward.ArticleId) domesticqty1  on domesticqty1.ArticleId=a.Id left join (select outward.ArticleId, (case when outward.NoPacks IS NULL then 0 else CASE WHEN CommaCheck(outward.NoPacks)= 0 THEN sum(outward.NoPacks) else sum(CountNoPacks(outward.NoPacks)) END end) as TotalExportOutQuantity, outwardnumber.Id, outwardnumber.OutwardDate from outwardnumber inner join outward on outward.OutwardNumberId=outwardnumber.Id inner join party p on p.Id=outward.PartyId where p.Id = 45 and outwardnumber.OutwardDate  < '".$startdate."' group by outward.ArticleId) exportqty1  on exportqty1.ArticleId=a.Id group by a.Id");
	
		$updated_data = [];
		foreach($data as $key => $vl){
			$object = (object)$vl;
			$totalopeninig_stock = ($data_open[$key]->TotalInwardQuantity_Open + $data_open[$key]->SalesReturnNoPacks_Open + $data_open[$key]->OutletSalesReturnNoPacks_Open + $data_open[$key]->TotalTransferNoPacks_Open) - ($data_open[$key]->TotalConsumedNoPacks_Open + $data_open[$key]->TotalInwardCancellation_Open + $data_open[$key]->PurchaseReturnNoPacks_Open + $data_open[$key]->TotalDomesticOutQuantity_Open + $data_open[$key]->TotalExportOutQuantity_Open + $data_open[$key]->stockshortage_Open);
			$closing_stock = ($totalopeninig_stock + $object->TotalInwardQuantity + $object->SalesReturnNoPacks + $object->OutletSalesReturnNoPacks + $object->TotalTransferNoPacks) - ($object->TotalConsumedNoPacks + $object->TotalInwardCancellation + $object->PurchaseReturnNoPacks + $object->TotalDomesticOutQuantity + $object->TotalExportOutQuantity + $object->stockshortage);
			$object->TotalOpeningStock = $totalopeninig_stock;
			$object->TotalInward = ($object->TotalInwardQuantity + $object->SalesReturnNoPacks + $object->OutletSalesReturnNoPacks + $object->TotalTransferNoPacks);
			$object->TotalOutwardQuantity = ($object->TotalConsumedNoPacks + $object->TotalInwardCancellation + $object->PurchaseReturnNoPacks + $object->TotalDomesticOutQuantity + $object->TotalExportOutQuantity + $object->stockshortage);
			$object->Closing = $closing_stock;
		
		    if($totalopeninig_stock!=0 || $object->TotalInwardQuantity!=0 || $object->SalesReturnNoPacks!=0 || $object->OutletSalesReturnNoPacks!=0 || $object->TotalTransferNoPacks!=0 || $object->TotalConsumedNoPacks!=0 || $object->TotalInwardCancellation!=0 || $object->PurchaseReturnNoPacks!=0 || $object->TotalDomesticOutQuantity!=0 || $object->TotalExportOutQuantity!=0){
		        array_push($updated_data, $object);
		    }
		    
		}
		
		return array("startdate"=>$startdate, "enddate"=>$enddate, "data"=>$updated_data);
	}
	...
	public function GetAllStocks()
    {
		...
		$data = DB::select("select dv.Id, dv.ArticleNumber, dv.ArticleOpenFlag, dv.SalesNoPacks, dv.TotalPieces, dv.ArticleColor, dv.ArticleSize, dv.ArticleRatio, dv.Colorflag, dv.Title, dv.BrandName, dv.Subcategory,  dv.SeriesName, dv.Series, dv.StyleDescription, CountNoPacks(dv.ArticleRatio) as TotalArticleRatio, DATE_FORMAT(dv.created_at, '%d/%m/%Y') as InwardDate  from (select * from (SELECT (case when pl.ProductStatus IS NULL then 1 else pl.ProductStatus end)  as ProductStatusData, a.Id, a.ArticleNumber, a.ArticleOpenFlag, inw.created_at, inw.SalesNoPacks, CountNoPacks(inw.SalesNoPacks) as TotalPieces, GROUP_CONCAT(DISTINCT CONCAT(ac.ArticleColorName) ORDER BY ac.Id SEPARATOR ',') as ArticleColor, GROUP_CONCAT(DISTINCT CONCAT(asz.ArticleSizeName) ORDER BY asz.Id SEPARATOR ',') as ArticleSize, a.ArticleRatio, cat.Colorflag, cat.Title, bn.Name as BrandName, subc.Name as Subcategory, rs.SeriesName, rs.Series, a.StyleDescription FROM `inward` inw inner join article a on a.Id=inw.ArticleId left join articlecolor ac on ac.ArticleId=a.Id left join articlesize asz on asz.ArticleId=a.Id left join po p on p.ArticleId=a.Id inner join category cat on cat.Id=a.CategoryId left join productlaunch pl on pl.ArticleId=a.Id left join brand bn on bn.Id= a.BrandId left join subcategory subc on subc.Id=a.SubCategoryId left join rangeseries rs on rs.Id=a.SeriesId group by a.Id) as ddd where ddd.ProductStatusData= 1 and ddd.ArticleOpenFlag=0 HAVING ddd.TotalPieces > 0 Union SELECT 1, a.Id, a.ArticleNumber, a.ArticleOpenFlag, '-', mxn.NoPacks as TotalPieces, '-', '-', '-', '-',c.Title, bn.Name as BrandName, subc.Name as Subcategory, rs.SeriesName, rs.Series, a.StyleDescription, '-' FROM `mixnopacks` mxn inner join article a on a.Id=mxn.ArticleId left join po p on p.ArticleId=a.Id left join category c on c.Id=a.CategoryId left join brand bn on bn.Id= a.BrandId left join subcategory subc on subc.Id=a.SubCategoryId left join rangeseries rs on rs.Id=a.SeriesId where a.ArticleOpenFlag=1 HAVING TotalPieces > 0) as dv");
